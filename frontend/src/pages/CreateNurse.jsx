...
/**
 * Component that registers a nurse with the system.
 */
const NurseRegister = () => {
  const [err, setError] = useState([]);

  /**
   * Handles the "Register Nurse" form submission.
   * 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:3001/auth/nurse', {
      ...
      window.location.href = `/nurses/login`;
    } catch (error) {
      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 3 }}>
            ...
            <Link href="/nurses/login">Back to login</Link>
          </Box>
        </Box>
      </Container>
    </ThemeProvider>
